// @ts-nocheck
import type * as __TypedOpenapi from "./homarr.types.js";

  import { Effect, Schema } from "effect";

// <Schemas>
export type error_BAD_REQUEST = __TypedOpenapi.Schemas.error_BAD_REQUEST;
export const error_BAD_REQUEST = Schema.Struct({ message: Schema.String, code: Schema.String, issues: Schema.optional(Schema.Array(Schema.Struct({ message: Schema.String }))) });

export type error_UNAUTHORIZED = __TypedOpenapi.Schemas.error_UNAUTHORIZED;
export const error_UNAUTHORIZED = Schema.Struct({ message: Schema.String, code: Schema.String, issues: Schema.optional(Schema.Array(Schema.Struct({ message: Schema.String }))) });

export type error_FORBIDDEN = __TypedOpenapi.Schemas.error_FORBIDDEN;
export const error_FORBIDDEN = Schema.Struct({ message: Schema.String, code: Schema.String, issues: Schema.optional(Schema.Array(Schema.Struct({ message: Schema.String }))) });

export type error_INTERNAL_SERVER_ERROR = __TypedOpenapi.Schemas.error_INTERNAL_SERVER_ERROR;
export const error_INTERNAL_SERVER_ERROR = Schema.Struct({ message: Schema.String, code: Schema.String, issues: Schema.optional(Schema.Array(Schema.Struct({ message: Schema.String }))) });

// </Schemas>

// <Endpoints>
export type get_AppRouter__all = __TypedOpenapi.Endpoints.get_AppRouter__all;
export const get_AppRouter__all = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/apps"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: Schema.Never,
  responses: { 200: Schema.Array(Schema.Struct({ id: Schema.String, name: Schema.String, description: Schema.NullOr(Schema.String), iconUrl: Schema.String, href: Schema.NullOr(Schema.String), pingUrl: Schema.NullOr(Schema.String) })), 401: error_UNAUTHORIZED, 403: error_FORBIDDEN, 500: error_INTERNAL_SERVER_ERROR },
};

export type post_AppRouter__create = __TypedOpenapi.Endpoints.post_AppRouter__create;
export const post_AppRouter__create = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/apps"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: Schema.Struct({ name: Schema.String.check(Schema.isMinLength(1), Schema.isMaxLength(64)), description: Schema.NullOr(Schema.String.check(Schema.isMaxLength(512))), iconUrl: Schema.String.check(Schema.isMinLength(1)), href: Schema.NullOr(Schema.Union([Schema.String.check(Schema.isPattern(new RegExp("^(?!javascript)[a-zA-Z]*:\\/\\/"))), Schema.Literal("")])), pingUrl: Schema.NullOr(Schema.Union([Schema.String.check(Schema.isPattern(new RegExp("^https?:\\/\\/"))), Schema.Literal("")])) }) },
  responses: { 200: Schema.Struct({ appId: Schema.String, id: Schema.String, name: Schema.String, description: Schema.NullOr(Schema.String), iconUrl: Schema.String, href: Schema.NullOr(Schema.String), pingUrl: Schema.NullOr(Schema.String) }), 400: error_BAD_REQUEST, 401: error_UNAUTHORIZED, 403: error_FORBIDDEN, 500: error_INTERNAL_SERVER_ERROR },
};
...
// </Endpoints>
     ...
     get: {
           "/api/apps": get_AppRouter__all as any
         },
post: {
           "/api/apps": post_AppRouter__create as any
         }
     }
