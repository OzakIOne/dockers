// @ts-nocheck
import type * as __TypedOpenapi from "./sonarr.types.js";
...
export const SelectOption = Schema.Struct({ value: Schema.optional(Schema.Int), name: Schema.optional(Schema.NullOr(Schema.String)), order: Schema.optional(Schema.Int), hint: Schema.optional(Schema.NullOr(Schema.String)) });
...
export type EpisodeTitleRequiredType = __TypedOpenapi.Schemas.EpisodeTitleRequiredType;
export const EpisodeTitleRequiredType = Schema.Literals(["always", "bulkSeasonReleases", "never"]);

export type FileDateType = __TypedOpenapi.Schemas.FileDateType;
export const FileDateType = Schema.Literals(["none", "localAirDate", "utcAirDate"]);
...
export type SeasonPackUpgradeType = __TypedOpenapi.Schemas.SeasonPackUpgradeType;
export const SeasonPackUpgradeType = Schema.Literals(["all", "threshold", "any"]);

export type MediaManagementSettingsResource = __TypedOpenapi.Schemas.MediaManagementSettingsResource;
export const MediaManagementSettingsResource = Schema.Struct({ id: Schema.optional(Schema.Int), autoUnmonitorPreviouslyDownloadedEpisodes: Schema.optional(Schema.Boolean), recycleBin: Schema.optional(Schema.NullOr(Schema.String)), recycleBinCleanupDays: Schema.optional(Schema.Int), downloadPropersAndRepacks: Schema.optional(ProperDownloadTypes), createEmptySeriesFolders: Schema.optional(Schema.Boolean), deleteEmptyFolders: Schema.optional(Schema.Boolean), fileDate: Schema.optional(FileDateType), rescanAfterRefresh: Schema.optional(RescanAfterRefreshType), setPermissionsLinux: Schema.optional(Schema.Boolean), chmodFolder: Schema.optional(Schema.NullOr(Schema.String)), chownGroup: Schema.optional(Schema.NullOr(Schema.String)), episodeTitleRequired: Schema.optional(EpisodeTitleRequiredType), skipFreeSpaceCheckWhenGrabbing: Schema.optional(Schema.Boolean), skipFreeSpaceCheckWhenImporting: Schema.optional(Schema.Boolean), minimumFreeSpaceWhenImporting: Schema.optional(Schema.Int), copyUsingHardlinks: Schema.optional(Schema.Boolean), useScriptImport: Schema.optional(Schema.Boolean), scriptImportPath: Schema.optional(Schema.NullOr(Schema.String)), importExtraFiles: Schema.optional(Schema.Boolean), extraFileExtensions: Schema.optional(Schema.NullOr(Schema.String)), enableMediaInfo: Schema.optional(Schema.Boolean), userRejectedExtensions: Schema.optional(Schema.NullOr(Schema.String)), seasonPackUpgrade: Schema.optional(SeasonPackUpgradeType), seasonPackUpgradeThreshold: Schema.optional(Schema.Number) });

export type Severity = __TypedOpenapi.Schemas.Severity;
export const Severity = Schema.Literals(["error", "warning", "info"]);

export type ValidationFailure = __TypedOpenapi.Schemas.ValidationFailure;
export const ValidationFailure = Schema.Struct({ propertyName: Schema.optional(Schema.NullOr(Schema.String)), errorMessage: Schema.optional(Schema.NullOr(Schema.String)), attemptedValue: Schema.optional(Schema.Null), customState: Schema.optional(Schema.Null), severity: Schema.optional(Severity), errorCode: Schema.optional(Schema.NullOr(Schema.String)), formattedMessageArguments: Schema.optional(Schema.NullOr(Schema.Array(Schema.Unknown))), formattedMessagePlaceholderValues: Schema.optional(Schema.NullOr(Schema.Record(Schema.String, Schema.Null))) });

export type ProviderTestAllResult = __TypedOpenapi.Schemas.ProviderTestAllResult;
export const ProviderTestAllResult = Schema.Struct({ id: Schema.optional(Schema.Int), isValid: Schema.optional(Schema.Boolean), validationFailures: Schema.optional(Schema.NullOr(Schema.Array(ValidationFailure))) });
...
export const RootFolderResource = Schema.Struct({ id: Schema.optional(Schema.Int), path: Schema.optional(Schema.NullOr(Schema.String)), accessible: Schema.optional(Schema.Boolean), isEmpty: Schema.optional(Schema.Boolean), freeSpace: Schema.optional(Schema.NullOr(Schema.Int)), totalSpace: Schema.optional(Schema.NullOr(Schema.Int)), unmappedFolders: Schema.optional(Schema.NullOr(Schema.Array(UnmappedFolder))) });

export type SkipValidation = __TypedOpenapi.Schemas.SkipValidation;
export const SkipValidation = Schema.Literals(["none", "warnings", "all"]);

// </Schemas>

// <Endpoints>
export type get__api_v5_downloadclient = __TypedOpenapi.Endpoints.get__api_v5_downloadclient;
export const get__api_v5_downloadclient = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/downloadclient"),
...
export type post__api_v5_downloadclient = __TypedOpenapi.Endpoints.post__api_v5_downloadclient;
export const post__api_v5_downloadclient = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/v5/downloadclient"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ skipTesting: Union_default_false_prop, skipValidation: Schema.optional(SkipValidation) })), body: DownloadClientResource },
  responses: { 201: DownloadClientResource, 404: Schema.Unknown },
};

export type put__api_v5_downloadclient_Id = __TypedOpenapi.Endpoints.put__api_v5_downloadclient_Id;
export const put__api_v5_downloadclient_Id = {
  method: Schema.Literal("PUT"),
  path: Schema.Literal("/api/v5/downloadclient/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ skipTesting: Union_default_false_prop, skipValidation: Schema.optional(SkipValidation) })), path: Schema.Struct({ id: Schema.NumberFromString.check(Schema.isInt()) }), body: DownloadClientResource },
  responses: { 202: DownloadClientResource, 404: Schema.Unknown },
};

export type delete__api_v5_downloadclient_Id = __TypedOpenapi.Endpoints.delete__api_v5_downloadclient_Id;
export const delete__api_v5_downloadclient_Id = {
...
export type get__api_v5_downloadclient_Id = __TypedOpenapi.Endpoints.get__api_v5_downloadclient_Id;
export const get__api_v5_downloadclient_Id = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/downloadclient/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.NumberFromString.check(Schema.isInt()) }) },
  responses: { 200: DownloadClientResource, 404: Schema.Unknown },
};

export type put__api_v5_downloadclient_bulk = __TypedOpenapi.Endpoints.put__api_v5_downloadclient_bulk;
export const put__api_v5_downloadclient_bulk = {
  method: Schema.Literal("PUT"),
  path: Schema.Literal("/api/v5/downloadclient/bulk"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: DownloadClientBulkResource },
  responses: { 200: Schema.Array(DownloadClientResource), 400: Schema.Unknown },
};

export type delete__api_v5_downloadclient_bulk = __TypedOpenapi.Endpoints.delete__api_v5_downloadclient_bulk;
export const delete__api_v5_downloadclient_bulk = {
  method: Schema.Literal("DELETE"),
  path: Schema.Literal("/api/v5/downloadclient/bulk"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
...
export type get__api_v5_downloadclient_schema = __TypedOpenapi.Endpoints.get__api_v5_downloadclient_schema;
export const get__api_v5_downloadclient_schema = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/downloadclient/schema"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: Schema.Never,
  responses: { 200: Schema.Array(DownloadClientResource) },
...
export type post__api_v5_downloadclient_test = __TypedOpenapi.Endpoints.post__api_v5_downloadclient_test;
export const post__api_v5_downloadclient_test = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/v5/downloadclient/test"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { query: Schema.optional(Schema.Struct({ skipValidation: Schema.optional(SkipValidation) })), body: DownloadClientResource },
  responses: { 204: Schema.Unknown },
};

export type post__api_v5_downloadclient_testall = __TypedOpenapi.Endpoints.post__api_v5_downloadclient_testall;
export const post__api_v5_downloadclient_testall = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/v5/downloadclient/testall"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: Schema.Never,
  responses: { 200: Schema.Array(ProviderTestAllResult), 400: Schema.Array(ProviderTestAllResult) },
};

export type post__api_v5_downloadclient_action_Name = __TypedOpenapi.Endpoints.post__api_v5_downloadclient_action_Name;
export const post__api_v5_downloadclient_action_Name = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/v5/downloadclient/action/{name}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
...
export type get__api_v5_settings_mediamanagement = __TypedOpenapi.Endpoints.get__api_v5_settings_mediamanagement;
export const get__api_v5_settings_mediamanagement = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/settings/mediamanagement"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: Schema.Never,
  responses: { 200: MediaManagementSettingsResource },
};

export type put__api_v5_settings_mediamanagement_Id = __TypedOpenapi.Endpoints.put__api_v5_settings_mediamanagement_Id;
export const put__api_v5_settings_mediamanagement_Id = {
  method: Schema.Literal("PUT"),
  path: Schema.Literal("/api/v5/settings/mediamanagement/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.String }), body: MediaManagementSettingsResource },
  responses: { 202: MediaManagementSettingsResource, 404: Schema.Unknown },
};

export type get__api_v5_settings_mediamanagement_Id = __TypedOpenapi.Endpoints.get__api_v5_settings_mediamanagement_Id;
export const get__api_v5_settings_mediamanagement_Id = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/settings/mediamanagement/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.NumberFromString.check(Schema.isInt()) }) },
  responses: { 200: MediaManagementSettingsResource, 404: Schema.Unknown },
};

export type post__api_v5_rootfolder = __TypedOpenapi.Endpoints.post__api_v5_rootfolder;
export const post__api_v5_rootfolder = {
  method: Schema.Literal("POST"),
  path: Schema.Literal("/api/v5/rootfolder"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { body: RootFolderResource },
  responses: { 201: RootFolderResource, 404: Schema.Unknown },
};

export type get__api_v5_rootfolder = __TypedOpenapi.Endpoints.get__api_v5_rootfolder;
export const get__api_v5_rootfolder = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/rootfolder"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
...
export type delete__api_v5_rootfolder_Id = __TypedOpenapi.Endpoints.delete__api_v5_rootfolder_Id;
export const delete__api_v5_rootfolder_Id = {
  method: Schema.Literal("DELETE"),
  path: Schema.Literal("/api/v5/rootfolder/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.NumberFromString.check(Schema.isInt()) }) },
  responses: { 204: Schema.Unknown },
...
export type get__api_v5_rootfolder_Id = __TypedOpenapi.Endpoints.get__api_v5_rootfolder_Id;
export const get__api_v5_rootfolder_Id = {
  method: Schema.Literal("GET"),
  path: Schema.Literal("/api/v5/rootfolder/{id}"),
  requestFormat: Schema.Literal("json"),
  responseFormat: Schema.Literal("json"),
  parameters: { path: Schema.Struct({ id: Schema.NumberFromString.check(Schema.isInt()) }) },
  responses: { 200: RootFolderResource, 404: Schema.Unknown },
};
...
// </Endpoints>
     ...
     get: {
           "/api/v5/downloadclient": get__api_v5_downloadclient as any,
"/api/v5/downloadclient/{id}": get__api_v5_downloadclient_Id as any,
"/api/v5/downloadclient/schema": get__api_v5_downloadclient_schema as any,
"/api/v5/settings/mediamanagement": get__api_v5_settings_mediamanagement as any,
"/api/v5/settings/mediamanagement/{id}": get__api_v5_settings_mediamanagement_Id as any,
"/api/v5/rootfolder": get__api_v5_rootfolder as any,
"/api/v5/rootfolder/{id}": get__api_v5_rootfolder_Id as any
         },
post: {
           "/api/v5/downloadclient": post__api_v5_downloadclient as any,
"/api/v5/downloadclient/test": post__api_v5_downloadclient_test as any,
"/api/v5/downloadclient/testall": post__api_v5_downloadclient_testall as any,
"/api/v5/downloadclient/action/{name}": post__api_v5_downloadclient_action_Name as any,
"/api/v5/rootfolder": post__api_v5_rootfolder as any
         },
put: {
           "/api/v5/downloadclient/{id}": put__api_v5_downloadclient_Id as any,
"/api/v5/downloadclient/bulk": put__api_v5_downloadclient_bulk as any,
"/api/v5/settings/mediamanagement/{id}": put__api_v5_settings_mediamanagement_Id as any
         },
delete: {
           "/api/v5/downloadclient/{id}": delete__api_v5_downloadclient_Id as any,
"/api/v5/downloadclient/bulk": delete__api_v5_downloadclient_bulk as any,
"/api/v5/rootfolder/{id}": delete__api_v5_rootfolder_Id as any
         }
     }
