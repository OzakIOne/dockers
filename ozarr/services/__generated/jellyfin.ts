...
export const AccessSchedule = Schema.Struct({ Id: Schema.optional(Schema.Int), UserId: Schema.optional(Schema.String.check(Schema.isUUID())), DayOfWeek: Schema.optional(DynamicDayOfWeek), StartHour: Schema.optional(Schema.Number), EndHour: Schema.optional(Schema.Number) });
...
export const UserConfiguration = Schema.Struct({ AudioLanguagePreference: Schema.optional(Schema.NullOr(Schema.String)), PlayDefaultAudioTrack: Schema.optional(Schema.Boolean), SubtitleLanguagePreference: Schema.optional(Schema.NullOr(Schema.String)), DisplayMissingEpisodes: Schema.optional(Schema.Boolean), GroupedFolders: Schema.optional(Schema.Array(Schema.String.check(Schema.isUUID()))), SubtitleMode: Schema.optional(SubtitlePlaybackMode), DisplayCollectionsView: Schema.optional(Schema.Boolean), EnableLocalPassword: Schema.optional(Schema.Boolean), OrderedViews: Schema.optional(Schema.Array(Schema.String.check(Schema.isUUID()))), LatestItemsExcludes: Schema.optional(Schema.Array(Schema.String.check(Schema.isUUID()))), MyMediaExcludes: Schema.optional(Schema.Array(Schema.String.check(Schema.isUUID()))), HidePlayedInLatest: Schema.optional(Schema.Boolean), RememberAudioSelections: Schema.optional(Schema.Boolean), RememberSubtitleSelections: Schema.optional(Schema.Boolean), EnableNextEpisodeAutoPlay: Schema.optional(Schema.Boolean), CastReceiverId: Schema.optional(Schema.NullOr(Schema.String)) });
